<div class="bg-light border-right" id="sidebar-wrapper">
  ...
  <div class="list-group list-group-flush">
    ...
    @if(Auth::user()->isAdmin() || Auth::user()->isHelpdesk())
      ...
      <a href="{{ route('pesan.index-admin') }}" class="list-group-item list-group-item-action bg-light">Bantuan dan Keluhan</a>
    ...
    @else
      ...
      <a href="{{ route('pesan.index') }}" class="list-group-item list-group-item-action bg-light">Bantuan dan Keluhan</a>
    @endif
  </div>
</div>
